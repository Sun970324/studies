  ...
  return (
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        <label
          htmlFor="price"
          className="mt-8 mb-1 block text-sm font-medium text-gray-700"
        >
          Price
        </label>
      ...
      <div>
        <label className="mt-8 mb-1 block text-sm font-medium text-gray-700">
          Description
        </label> 
          <textarea className="mt-1 shadow-sm w-full focus:ring-orange-500 rounded-md border-gray-300 focus:border-orange-500" rows={4} />
      </div>
      <button className="mt-4 w-full rounded-md border border-transparent bg-orange-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">Upload product</button>
    </div>
  );
};
